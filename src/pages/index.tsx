  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Blog da Rocketseat" />
      </Head>
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <a href="https://github.com/Viniciusrbr" aria-label='Github'>
      ...
      <main>
        <article className={styles.content}>
          ...
          <h3>O que é acessbilidade, afinal ?</h3>
        </article>
      </main>
      ...
      <footer className={styles.footer}>
        ...
        <nav className={styles.nav} aria-label='Rodapé' >
          <button type='button' onClick={handleOpenModal} aria-controls='modal1' >
            Termos de uso
          </button>
        </nav>
      </footer>
      ...
      {isModalOpen && (
        <div id='modal1' ref={ModalRef} className={styles.modal} role='dialog'
          aria-labelledby='modalTitle'
          aria-describedby='modalDescription' tabIndex={-1}
        >
